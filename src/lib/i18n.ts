...
export const dict = {
  ...
  statsTitle: { en: "Community stats", fr: "Statistiques de la communauté", he: "נתוני הקהילה" },
  statsCaption: {
    en: "Everyone using this guide, all together:",
    fr: "Tous les utilisateurs du guide, réunis :",
    he: "כל מי שמשתמש במדריך, ביחד:",
  },
  statsDevices: { en: "Devices", fr: "Appareils", he: "מכשירים" },
  statsSessions: { en: "Visits", fr: "Visites", he: "ביקורים" },
  statsMinutes: { en: "Minutes used", fr: "Minutes d'utilisation", he: "דקות שימוש" },
  statsSearches: { en: "Searches", fr: "Recherches", he: "חיפושים" },
  statsTaps: { en: "Cards opened", fr: "Fiches ouvertes", he: "כרטיסים שנפתחו" },
  statsFavorites: { en: "Favorites saved", fr: "Favoris enregistrés", he: "מועדפים שנשמרו" },
  statsAsks: { en: "Questions asked", fr: "Questions posées", he: "שאלות שנשאלו" },
  statsShares: { en: "Shares", fr: "Partages", he: "שיתופים" },
  nudgeTitle: { en: "Put us one tap away", fr: "À un geste de vous", he: "במרחק הקשה אחת" },
  nudgeIntro: {
    en: "Add Welcome to Ra'anana to your home screen — it opens instantly, full-screen, and works offline.",
    fr: "Ajoutez Bienvenue à Ra'anana à votre écran d'accueil — ouverture instantanée, plein écran, et hors ligne.",
    he: "הוסיפו את המדריך למסך הבית — נפתח מיד, במסך מלא, וגם בלי אינטרנט.",
  },
  nudgeIosStep1: {
    en: "Tap the Share button at the bottom of Safari (the square with an arrow).",
    fr: "Touchez le bouton Partager en bas de Safari (le carré avec une flèche).",
    he: "הקישו על כפתור השיתוף בתחתית ספארי (ריבוע עם חץ).",
  },
  nudgeIosStep2: {
    en: 'Scroll down and tap "Add to Home Screen".',
    fr: "Faites défiler et touchez « Sur l'écran d'accueil ».",
    he: 'גללו מטה והקישו על "הוספה למסך הבית".',
  },
  nudgeIosStep3: {
    en: 'Tap "Add" — the app gets its own icon.',
    fr: "Touchez « Ajouter » — l'app aura sa propre icône.",
    he: 'הקישו "הוספה" — האפליקציה תקבל אייקון משלה.',
  },
  nudgeAndroidStep1: {
    en: "Tap the ⋮ menu in the top corner of Chrome.",
    fr: "Touchez le menu ⋮ en haut de Chrome.",
    he: "הקישו על תפריט ⋮ בפינת כרום.",
  },
  nudgeAndroidStep2: {
    en: 'Tap "Add to Home screen" (or "Install app").',
    fr: "Touchez « Ajouter à l'écran d'accueil » (ou « Installer l'appli »).",
    he: 'הקישו על "הוספה למסך הבית" (או "התקנת אפליקציה").',
  },
  nudgeAndroidStep3: {
    en: "Confirm — the app gets its own icon.",
    fr: "Confirmez — l'app aura sa propre icône.",
    he: "אשרו — האפליקציה תקבל אייקון משלה.",
  },
  nudgeOtherStep: {
    en: 'In your browser menu, choose "Install app" or "Add to Home Screen".',
    fr: "Dans le menu du navigateur, choisissez « Installer l'application » ou « Ajouter à l'écran d'accueil ».",
    he: 'בתפריט הדפדפן בחרו "התקנת אפליקציה" או "הוספה למסך הבית".',
  },
  nudgeInstallNow: { en: "Install now", fr: "Installer maintenant", he: "להתקין עכשיו" },
  nudgeRemindLater: { en: "Remind me later", fr: "Me le rappeler plus tard", he: "להזכיר לי אחר כך" },
  nudgeDontShowAgain: { en: "Don't show this again", fr: "Ne plus afficher", he: "לא להציג שוב" },
  correctionText: {
